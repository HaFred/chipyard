...
trait SPadSizeConfig {
  ...
  protected val inActDataSPadSize: Int = 64
  ...
  protected val inActAdrIdxWidth: Int = log2Ceil(inActAdrSPadSize)           // f: up to ceiling
...
trait PESizeConfig {
  ...
  protected val inActAdrWidth: Int = 7
  ...
  protected val inActZeroColumnCode: Int = pow(2, inActAdrWidth).toInt - 1  // fred: 127
